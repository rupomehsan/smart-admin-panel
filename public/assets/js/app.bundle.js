        ...
        function i(e, t) {
            ...
            function c() {
                (o = p("#" + t.wrapperId).outerWidth()),
                    (i = p
                        .map(s.children("li:not(.nav-title)"), function (e) {
            ...
            return (
                ...
                p("#" + t.wrapperId + "-left-btn").click(function (e) {
                    c(), n < 0 ? (a = Math.min(n + o, 0)) : ((a = n), console.log("left end")), s.css({ marginLeft: a }), e.preventDefault();
                }),
                p("#" + t.wrapperId + "-right-btn").click(function (e) {
                    c(), -n + o < i ? (a = Math.max(n - o, -(i - o))) : ((a = n), console.log("right end")), s.css({ marginLeft: a }), e.preventDefault();
                }),
                l("onInit"),
                {
                    option: function (e, o) {
...
var initApp = (function (e) {
        return (
            ...
            (e.removeSettings = function (e) {
                var o;
                null != e
                    ? ((o = initApp.getSettings().replace(e, "")),
                      myapp_config.root_.removeClass(function (e, o) {
                          return (o.match(/(^|\s)(nav-|header-|footer-|mod-|display-)\S+/g) || []).join(" ");
                      }),
            ...
            (e.domReadyMisc = function () {
                ...
                $(".custom-file input").change(function (e) {
                    ...
                    myapp_config.appDateHook.length &&
                        ((o =
                            ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"][(e = new Date()).getDay()] +
                            ", " +
                    ...
                    myapp_config.activateLastTab &&
                        ((t = localStorage.getItem("lastTab")),
                    ...
                    void 0 !== $.fn.slimScroll && "desktop" === myapp_config.thisDevice
                        ? ($(".custom-scroll:not(.disable-slimscroll) >:first-child").slimscroll({
                          ...
                          myapp_config.debugState && console.log("%câœ” SlimScroll plugin active", "color: #148f32"))
                    ...
                    void 0 !== initApp.listFilter &&
                        ...
                        ((n = $("[data-listfilter]").attr("id")), (i = $("[data-listfilter]").attr("data-listfilter")), initApp.listFilter(i, "#" + n)),
                    void 0 !== $.fn.tooltip && $('[data-toggle="tooltip"]').length ? $('[data-toggle="tooltip"]').tooltip() : console.log("OOPS! bs.tooltip is not loaded"),
                    void 0 !== $.fn.popover && $('[data-toggle="popover"]').length && ($.fn.tooltip.Constructor.Default.whiteList, $('[data-toggle="popover"]').popover({ sanitize: !1 })),
                    void 0 !== $.fn.dropdown ? (Popper.Defaults.modifiers.computeStyle.gpuAcceleration = !1) : console.log(),
                    ...
                    window.Waves && myapp_config.rippleEffect
                        ? (Waves.attach(".nav-menu:not(.js-waves-off) a, .btn:not(.js-waves-off):not(.btn-switch), .js-waves-on", ["waves-themed"]),
                          Waves.init(),
                          myapp_config.debugState && console.log())
                        : myapp_config.debugState && console.log(),
                                    ...
                                    ? (initApp.playSound("media/sound", "messagebox"),
                                      bootbox.confirm({
                                          title:
                                              ...
                                              r.children(".panel-hdr").children("h2").text().trim() +
                                              "'&nbsp;</span>?",
                            ...
                            case "lang" === o:
                                ...
                                $.i18n
                                    ...
                                    : initApp.loadScript("js/i18n/i18n.js", function () {
                                          $.i18n.init({ resGetPath: "media/data/__lng__.json", load: "unspecific", fallbackLng: !1, lng: p }, function (e) {
                    ...
                    navigator.userAgent.match(/IEMobile\/10\.0/) && ((a = document.createElement("style")).appendChild(document.createTextNode("@-ms-viewport{width:auto!important}")), document.head.appendChild(a)),
                    myapp_config.debugState && console.log();
            }),
            e
        );
