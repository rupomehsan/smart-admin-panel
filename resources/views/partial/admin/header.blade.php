...
<body class="mod-bg-1 mod-nav-link desktop chrome webkit pace-done" cz-shortcut-listen="true">
    ...
    <header class="page-header" role="banner">
        ...
        <div class="hidden-lg-up">
            <a href="#" class="header-btn btn press-scale-down waves-effect waves-themed" data-action="toggle"
                    ...
                    <div class="custom-scroll h-100">
                        <div class="slimScrollDiv"
                            ...
                            <ul class="app-list" style="overflow: hidden; width: auto; height: 100%;">
                                ...
                                <li class="w-100">
                                    <a href="#" class="btn btn-default mt-4 mb-2 pr-5 pl-5 waves-effect waves-themed">
                                        Add more apps </a>
                                </li>
                            </ul>
                            <div class="slimScrollBar"
                                style="background: rgba(0, 0, 0, 0.6); width: 4px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 4px; height: 237.798px;">
                            </div>
            ...
            <div>
                ...
                <div class="dropdown-menu dropdown-menu-animated dropdown-xl">
                    ...
                    <ul class="nav nav-tabs nav-tabs-clean" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link px-4 fs-md js-waves-on fw-500 waves-effect waves-themed"
                                data-toggle="tab" href="#tab-messages" data-i18n="drpdwn.messages">Messages</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link px-4 fs-md js-waves-on fw-500 waves-effect waves-themed"
                                        ...
                                        <li class="unread">
                                            <a href="#" class="d-flex align-items-center">
                                                ...
                                                <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <span class="msg-b fs-xs">Hello again and thanks for
                                                        being part...</span>
                                            ...
                                            <a href="#" class="d-flex align-items-center">
                                                ...
                                                <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <span class="msg-a fs-sm">Msed quia non numquam
                                                        eius</span>
                                                    <span class="fs-nano text-muted mt-1">2 minutes
                                                        ago</span>
                                                </span>
                                            </a>
                                        </li>
                                        ...
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                ...
                                                <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <span class="msg-a fs-sm">Msed quia non numquam
                                                        eius</span>
                                                    <span class="fs-nano text-muted mt-1">one month
                                                        ago</span>
                                                </span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="#" class="d-flex align-items-center">
                                                ...
                                                <span class="d-flex flex-column flex-1 ml-1">
                                                    ...
                                                    <span class="msg-a fs-sm">Msed quia non numquam
                                                        eius</span>
                                                    <span class="fs-nano text-muted mt-1">one year
                                                        ago</span>
                                                </span>
                                            </a>
                                        </li>
                                    ...
                                    <ul class="notification" style="overflow: hidden; width: auto; height: 100%;">
                                                ...
                                                <div class="d-flex flex-column flex-1">
                                                    <span class="name">
                                                        Adison Lee <span class="fw-300 d-inline">replied to
                                                            your video <a href="#" class="fw-400"> Cancer
                                                                Drug</a> </span>
                                                    </span>
                                                    <span class="msg-a fs-sm mt-2">Bring to the table
                                        ...
                                        <li>
                                            <div class="d-flex align-items-center show-child-on-hover">
                                                ...
                                                <div class="d-flex flex-column flex-1">
                                                    <div class="name mb-2">
                                                        Lisa Lamar<span class="fw-300"> updated
                                                            project</span>
                                                    </div>
                                        ...
                                        <tbody>
                                            <tr>
                                                <th colspan="7" class="pt-3 pb-2 pl-3 pr-3 text-center">
                                                    <div class="js-get-date h5 mb-2">Thursday, November 3,
                                                        2022</div>
                                                </th>
                                            </tr>
